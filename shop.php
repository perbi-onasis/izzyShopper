...
<body>
    <!-- Modal -->
    <!-- <div class="modal fade custom-modal" id="onloadModal" tabindex="-1" aria-labelledby="onloadModalLabel" aria-hidden="true" id="modal-1">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="deal" style="background-image: url('../assets/imgs/banner/popup-1.png')">
                        <div class="deal-top">
                            <h6 class="mb-10 text-brand-2">Special Deals for you</h6>
                        </div>
                        <div class="deal-content detail-info">
                            <h4 class="product-title"><a href="shop-product-right.html" class="text-heading">Sunday Fufu Special Package</a></h4>
                            <div class="clearfix product-price-cover">
                                <div class="product-price primary-color float-left">
                                    <span class="current-price text-brand">GHS98</span>
                                    <span>
                                        <span class="save-price font-md color3 ml-15">10% Off</span>
                                        <span class="old-price font-md ml-15">GHS83</span>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="deal-bottom">
                            ...
                            <a href="specialpackages.php" class="btn hover-up">Shop Now <i class="fi-rs-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade custom-modal" id="onloadModal" tabindex="-1" aria-labelledby="onloadModalLabel" aria-hidden="true" id="modal-2">
        <div class="modal-dialog">
            <div class="modal-content">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="modal-body">
                    <div class="deal" style="background-image: url('../assets/imgs/banner/popup-2.png')">
                        <div class="deal-top">
                            <h6 class="mb-10 text-brand-2">Special Deals for you</h6>
                        </div>
                        <div class="deal-content detail-info">
                            <h4 class="product-title"><a href="shop-product-right.html" class="text-heading"></a>Our Furry Friend's Products</h4>
                            <div class="clearfix product-price-cover">
                                <div class="product-price primary-color float-left">
                                    <span class="current-price text-brand">Affordable Prices</span>
                                    <!-- <span>
                                        <span class="save-price font-md color3 ml-15">10% Off</span>
                                        <span class="old-price font-md ml-15">GHS83</span>
                                    </span> -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="detail-info pr-30 pl-30">
                                ...
                                <div class="clearfix product-price-cover">
                                    <div class="product-price primary-color float-left">
                                        <span class="current-price text-brand">GHS38</span>
                                        <span>
                                            <span class="save-price font-md color3 ml-15">26% Off</span>
                                            <span class="old-price font-md ml-15">GHS52</span>
                                        </span>
                                    </div>
                                </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="header-info header-info-right">
                            <ul>
                                <!-- <li>Need help? Call Us: <strong class="text-brand"> (+233) 59 944 8106</strong></li> -->
                                 <li>Find us on our social media platforms</li>
                                <a href="https://www.facebook.com/share/ewFrLx3ggp8KdR9i/?mibextid=LQQJ4d" target="_blank"><i class="fi fi-brands-facebook"></i></a>
                                <a href="https://www.instagram.com/izzyshopper_?igsh=MWl3angxeWVyZ2o2aA==" target="_blank"><i class="fi fi-brands-instagram"></i></a>
                                <a href="https://x.com/izzyshopper_?s=21&t=j7dzjiHzKS_LzyVaMA9L5Q"><i class="fi fi-brands-twitter-alt-circle"></i></a>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="header-middle header-middle-ptb-1 d-none d-lg-block">
            <div class="container">
                <div class="header-wrap">
                    <div class="logo">
                        <a href="shop.html"><img src="../assets/imgs/theme/logo.png" alt="logo" /></a>
                    </div>
                                    ...
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                        ...
                                        <div class="shopping-cart-footer">
                                            <div class="shopping-cart-total">
                                                <h4>Total <span>GHS4000.00</span></h4>
                                            </div>
        ...
        <div class="header-bottom header-bottom-bg-color sticky-bar">
            <div class="container">
                <div class="header-wrap header-space-between position-relative">
                    <div class="logo logo-width-1 d-block d-lg-none ml-60">
                        <a href="shop.html"><img src="../assets/imgs/theme/logo.png" alt="logo" /></a>
                    </div>
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                            <nav>
                                <ul>
                                    ...
                                    <li>
                                        <a class="active" href="shop.html">Home</a>                                        
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="blog-category-grid.html">Special Packages</a>                                        
                                    </li>
                                    <li>
                    ...
                    <div class="header-action-right d-block d-lg-none">
                        <div class="header-action-2">
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <!-- Cart Dropdown Content for Quick View -->
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    <ul>
                                        <li>
                                            <div class="shopping-cart-img">
                                    ...
                                    <div class="shopping-cart-footer">
                                        <div class="shopping-cart-total">
                                            <h4>Total <span>GHS383.00</span></h4>
                                        </div>
                                        <div class="shopping-cart-button">
                                ...
                                <!-- Cart Dropdown Content for Quick View  Ends Here-->
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="mobile-header-wrapper-inner">
            ...
            <div class="mobile-header-content-area">
                ...
                <div class="mobile-menu-wrap mobile-header-border">
                    ...
                    <nav>
                        <ul class="mobile-menu font-heading">
                            ...
                            <li class="">
                                <a href="shop.php">Special Packages</a>
                            </li>
                            <li class="">
                                <a href="shop.php">Contact Us</a>
                            </li>
                            <li class="">
                                <a href="shop.php">Deals</a>
                            </li>
                ...
                <div class="mobile-header-info-wrap">
                    ...
                    <div class="single-mobile-header-info">
                        <a href="#"><i class="fi-rs-headphones"></i>(+233) 54 751 3921 </a>
                    </div>
                </div>
                ...
                <div class="site-copyright">Copyright 2024 © IzzyShopper. <br>All rights reserved.</div>
                    ...
                    <div class="hero-slider-1 style-4 dot-style-1 dot-style-1-position-1">
                        <div class="single-hero-slider single-animation-wrap" style="background-image: url(../assets/imgs/slider/slider-1.png)">
                            <div class="slider-content">
                                ...
                                <p class="mb-65">Search for amazing products here </p>
                                <form class="form-subcriber d-flex">
                                    <input type="email" placeholder="Search for products here" />
        ...
        <section class="product-tabs section-padding position-relative">
            <div class="container">
               <div class="row ">
                ...
                <div class="row product-grid m-auto">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <div class="product-card-bottom">
                                    <div class="product-price">
                                        <span>GHS28.85</span>
                                        <span class="old-price">GHS32.8</span>
                                    </div>
                                    <div class="add-cart">
                        ...
                        <div class="product-cart-wrap mb-30">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <div class="product-card-bottom">
                                    <div class="product-price">
                                        <span>GHS52.85</span>
                                        <span class="old-price">GHS55.8</span>
                                    </div>
                                    <div class="add-cart">
                                        <a class="add" href="cart.html"><i class="fi-rs-shopping-cart mr-5"></i>Add </a>
                                    </div>
                        ...
                        <div class="product-cart-wrap mb-30">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <div class="product-card-bottom">
                                    <div class="product-price">
                                        <span>GHS48.85</span>
                                        <span class="old-price">GHS52.8</span>
                                    </div>
                                    <div class="add-cart">
                                        <a class="add" href="cart.html"><i class="fi-rs-shopping-cart mr-5"></i>Add </a>
                                    </div>
                        ...
                        <div class="product-cart-wrap mb-30">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <div class="product-card-bottom">
                                    <div class="product-price">
                                        <span>GHS17.85</span>
                                        <span class="old-price">GHS19.8</span>
                                    </div>
                                    <div class="add-cart">
                                        <a class="add" href="cart.html"><i class="fi-rs-shopping-cart mr-5"></i>Add </a>
                                    </div>
                        ...
                        <div class="product-cart-wrap mb-30">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <div class="product-card-bottom">
                                    <div class="product-price">
                                        <span>GHS23.85</span>
                                        <span class="old-price">GHS25.8</span>
                                    </div>
                                    <div class="add-cart">
                                        <a class="add" href="cart.html"><i class="fi-rs-shopping-cart mr-5"></i>Add </a>
                                    </div>
                        ...
                        <div class="product-cart-wrap mb-30">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <div class="product-card-bottom">
                                    <div class="product-price">
                                        <span>GHS32.85</span>
                                        <span class="old-price">GHS33.8</span>
                                    </div>
                                    <div class="add-cart">
                                        <a class="add" href="cart.html"><i class="fi-rs-shopping-cart mr-5"></i>Add </a>
                                    </div>
                        ...
                        <div class="product-cart-wrap mb-30">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <div class="product-card-bottom">
                                    <div class="product-price">
                                        <span>GHS35.85</span>
                                        <span class="old-price">GHS37.8</span>
                                    </div>
                                    <div class="add-cart">
                                        <a class="add" href="cart.html"><i class="fi-rs-shopping-cart mr-5"></i>Add </a>
                                    </div>
                        ...
                        <div class="product-cart-wrap mb-30">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <div class="product-card-bottom">
                                    <div class="product-price">
                                        <span>GHS22.85</span>
                                        <span class="old-price">GHS24.8</span>
                                    </div>
                                    <div class="add-cart">
                                        <a class="add" href="cart.html"><i class="fi-rs-shopping-cart mr-5"></i>Add </a>
                                    </div>
                                        ...
                                        <div class="product-cart-wrap">
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <div class="product-price mt-10">
                                                    <span>GHS238.85 </span>
                                                    <span class="old-price">GHS245.8</span>
                                                </div>
                                                ...
                                                <a href="cart.html" class="btn w-100 hover-up"><i class="fi-rs-shopping-cart mr-5"></i>Add To Cart</a>
                                            </div>
                                        </div>
                                        <!--End product Wrap-->
                                        <div class="product-cart-wrap">
